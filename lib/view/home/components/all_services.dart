                      ...
                      children: [
                        ...
                        Consumer<AllServicesService>(
                          builder: (context, allServiceProvider, child) =>
                            ...
                            cc: cc,
                            title: asProvider
                                .getString('Featured Services listed'),
                            pressed: () {
                              //when user clicks on recent see all. set sort by dropdown to latest
                              allServiceProvider.setSortbyValue('Lowest Price');
                              allServiceProvider
                                  .setSelectedSortbyId('lowest_price');
                        ...
                        Container(
                          ...
                          child: ListView(
                            ...
                            children: [
                              for (int i = provider.recentServiceMap.length - 1;
                                  i >= 0;
                                  i--)
                                InkWell(
